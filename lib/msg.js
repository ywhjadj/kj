...
const sms = (conn, m, store) => {
    ...
    if (m.message) {
        ...
        // FIXED: Added optional chaining to prevent crash when m.msg is undefined
        let quoted = (m.quoted = m.msg?.contextInfo?.quotedMessage) || null;
        // FIXED: Added optional chaining here too
        ...
        if (m.quoted) {
          ...
          } else 
          {
            ...
            m.quoted.mtype = type
            // FIXED: Added optional chaining to prevent crash at line 120
    ...
    // YOUR FIX: Added optional chaining here
